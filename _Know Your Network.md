...
conf t
 int vlan 1
  ip add 10.#$81T#.1.2 255.255.255.0
...
Task:
 1. CoreTAAS must have the following SVIs
   - VLAN 1
       - IP address: 10.#$81T#.1.2
       - Description: DEFAULT-VLAN
       - Status: UP

   - VLAN 10
     - IP address: 10.#$81T#.10.2
     - Description: WIFI-VLAN
     - Status: UP

   - VLAN 50
     - IP address: 10.#$81T#.50.2
     - Description: CCTV-VLAN
     - Status: UP

   - VLAN 100
     - IP address: 10.#$81T#.100.2
...
conf t
 int vlan 1
  ...
  exit
 int vlan 10
  ip add 10.#$81T#.10.2 255.255.255.0
  description WIFI-VLAN
  no shut
  exit
 int vlan 50
  ip add 10.#$81T#.50.2 255.255.255.0
  description CCTV-VLAN
  no shut
  exit
 int vlan 100
  ip add 10.#$81T#.100.2 255.255.255.0
  description VOICE-VLAN
  no shut
 end
~~~
...
conf t
 ...
 int gi 0/1
  no shut
  no switchport
  ip add 10.#$81T#.#$81T#.4 255.255.255.0
 int vlan 1
  no shut
  ip add 10.#$81T#.1.4 255.255.255.0
  desc DEFAULT-VLAN
 int vlan 10
  no shut
  ip add 10.#$81T#.10.4 255.255.255.0
  desc WIFI-VLAN
 int vlan 50
  no shut
  ip add 10.#$81T#.50.4 255.255.255.0
  desc CCTV-VLAN
 int vlan 100
  no shut
  ip add 10.#$81T#.100.4 255.255.255.0
  desc VOICE-VLAN
 end
~~~
...
!@CoreBABA
conf t
 ip dhcp excluded-address 10.#$81T#.1.1 10.#$81T#.1.100
 ip dhcp excluded-address 10.#$81T#.10.1 10.#$81T#.10.100
 ip dhcp excluded-address 10.#$81T#.50.1 10.#$81T#.50.100
 ip dhcp pool POOLDATA
  network 10.#$81T#.1.0 255.255.255.0
  default-router 10.#$81T#.1.4
  domain-name MGMTDATA.COM
  dns-server 10.#$81T#.1.10
 ip dhcp pool POOLWIFI
  network 10.#$81T#.10.0 255.255.255.0
  default-router 10.#$81T#.10.4
  domain-name WIFIDATA.COM
  dns-server 10.#$81T#.1.10
  option 43 ip 10.#$81T#.10.#$81T#
 ip dhcp pool POOLCCTV
  network 10.#$81T#.50.0 255.255.255.0
  default-router 10.#$81T#.50.4
...
!@CoreBABA
conf t
 ip dhcp excluded-address 10.#$81T#.100.1 10.#$81T#.100.100
 ip dhcp pool POOLVOICE
  network 10.#$81T#.100.0 255.255.255.0
  default-router 10.#$81T#.100.4
  domain-name VOICEDATA.COM
  dns-server 10.#$81T#.1.10
  option 150 ip 10.#$81T#.100.8
  lease 5 0 0
  end
~~~
...
conf t
 ...
 ip dhcp pool CAMERA6
  host 10.#$81T#.50.6 255.255.255.0
  client-identifier #camera6macadd#
 ip dhcp pool CAMERA8
  host 10.#$81T#.50.8 255.255.255.0
...
!@dhcp
conf t
 ip dhcp excluded-add 10.#$81T#.1.1 10.#$81T#.1.100
 ip dhcp excluded-add 10.#$81T#.10.1 10.#$81T#.10.100
 ip dhcp excluded-add 10.#$81T#.50.1 10.#$81T#.50.100
 ip dhcp excluded-add 10.#$81T#.100.1 10.#$81T#.100.100
 ip dhcp pool POOLDATA
  network 10.#$81T#.1.0 255.255.255.0
  default-router 10.#$81T#.1.4
  domain-name MGMTDATA.COM
...
conf t
 ...
 int fa 0/0
  no shut
  ip add 10.#$81T#.100.8 255.255.255.0
 end
~~~
...
conf t
 dial-peer voice 1 pots
  destination-pattern #$81T#00
  port 0/0/0
 dial-peer voice 2 pots
  destination-pattern #$81T#01
  port 0/0/1
 dial-peer voice 3 pots
  destination-pattern #$81T#02
  port 0/0/2
 dial-peer voice 4 pots
  destination-pattern #$81T#03
  port 0/0/3
 end
~~~
...
conf t
 ...
 telephony-service
  ...
  max-ephones 5
  max-dn 20
  ip source-address 10.#$81T#.100.8 port 2000
  end
~~~

<br>

*Why 10.#$81T#.100.8? __TFTP__*
...
config t
 dial-peer voice 69 voip
  ...
  destination-pattern #$81T#69
  session target ipv4:10.#$81T#.100.8
  incoming called-number #$81T#69
 ...
 application
  service rivanaa flash:app-b-acd-aa-3.0.0.2.tcl
   ...
   param voice-mail 1281
   param max-time-call-retry 700
   param aa-pilot #$81T#69
  service rivanqueue flash:app-b-acd-3.0.0.2.tcl
   param queue-len 15
   param aa-hunt1 #$81T#00
   param aa-hunt2 #$81T#01
   param aa-hunt3 #$81T#22
   param aa-hunt4 #$81T#66
...
Task:
 1. Set the hostname to EDGE-#$81T#
...
conf t
 ...
 ip route 10.#$81T#.0.0 255.255.0.0 10.#$81T#.#$81T#.4 254
 end
~~~
...
conf t
 ip routing
 ip route 0.0.0.0 0.0.0.0 10.#$81T#.100.4 254
 end
~~~
...
!@CoreBABA
conf t
 ip route 0.0.0.0 0.0.0.0 10.#$81T#.#$81T#.1 254
 end
~~~
...
~~~
!@cmd
route add 10.0.0.0 mask 255.0.0.0 10.#$81T#.1.4
route add 200.0.0.0 mask 255.255.255.0 10.#$81T#.1.4
~~~
...
network 10.#$81T#.#$81T#.0 0.0.0.255 area 0
network #$81T#.0.0.1 0.0.0.0 area 0
int gi 0/0/0
...
conf t
router ospf 1
router-id 10.#$81T#.#$81T#.4
network 10.#$81T#.0.0 0.0.255.255 area 0
int gi0/1
ip ospf network point-to-point
~~~
...
conf t
router ospf 1
router-id 10.#$81T#.100.8
network 10.#$81T#.100.0 0.0.0.255 area 0
end
~~~
...
~~~
!@cmd
ping 10.#$81T#.1.2                 CoreTAAS
ping 10.#$81T#.1.4                 CoreBABA
ping 10.#$81T#.100.8               CUCM
ping 10.#$81T#.#$81T#.1            EDGE
~~~
