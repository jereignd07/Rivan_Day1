...
Task:
 1. CoreTAAS must have the following SVIs
   - VLAN 1
       - IP address: 10.81.1.2
       - Description: DEFAULT-VLAN
       - Status: UP

   - VLAN 10
     - IP address: 10.81.10.2
     - Description: WIFI-VLAN
     - Status: UP

   - VLAN 50
     - IP address: 10.81.50.2
     - Description: CCTV-VLAN
     - Status: UP

   - VLAN 100
     - IP address: 10.81.100.2
...
!@CoreBABA
conf t
 ip dhcp excluded-address 10.81.1.1 10.81.1.100
 ip dhcp excluded-address 10.81.10.1 10.81.10.100
 ip dhcp excluded-address 10.81.50.1 10.81.50.100
...
!@CoreBABA
conf t
 ip dhcp excluded-address 10.81.100.1 10.81.100.100
...
conf t
 ...
 ip route 10.81.0.0 255.255.0.0 10.81.81.4 254
 end
~~~
...
conf t
 ip routing
 ip route 0.0.0.0 0.0.0.0 10.81.100.4 254
 end
~~~
...
!@CoreBABA
conf t
 ip route 0.0.0.0 0.0.0.0 10.81.81.1 254
 end
~~~
...
~~~
!@cmd
route add 10.0.0.0 mask 255.0.0.0 10.81.1.4
route add 200.0.0.0 mask 255.255.255.0 10.81.1.4
~~~
...
~~~
!@cmd
ping 10.81.1.2                 CoreTAAS
ping 10.81.1.4                 CoreBABA
ping 10.81.100.8               CUCM
ping 10.81.81.1            EDGE
~~~
